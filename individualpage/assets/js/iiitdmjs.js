...
function swiperSlider(){
    ...
    if($(".swiper-container").length){
        ...
        var $fullscreen = $(".iiiitdm-04, .hero-swiper, .hero-text, .hero-images");
...
/*-------------------------
     MAGNIFIC POPUP JS
-------------------------*/
function iiitdmkPopup() {

    "use strict";

    if (('.iiitdmk-items').length > 0) {
        $('.iiitdmk-items').each(function() {
            $(this).magnificPopup({
                ...
                callbacks: {
                    open: function() {
                        $.fn.iiitdmk.setKeyboardScrolling(false);

                    },
                    close: function() {
                        $.fn.iiitdmk.setKeyboardScrolling(true);
                    }
                  }
            });
        });
...
/*-------------------------
        ISOTOPE JS
-------------------------*/
function iiitdmkIsotop() {

    "use strict";

    var $container = $('.iiitdmk-items');
    var $filter = $('#iiitdmk-filter');
    $container.isotope({
        filter: '*',
        layoutMode: 'masonry',
        animationOptions: {
